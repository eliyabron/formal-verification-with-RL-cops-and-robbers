...
from utils import writeSmv, runSmv,writeSmv1, runSmv1
import math
...
class State:
    def __init__(self, init_vec=None, p1=None, p2=None, max_turns=50, exp_rate=0,start_q=0):
    ...
    def reset(self, a_vecs=None, l_vecs = None, num_of_players=None):
        ...
        if self.start_q==1:
         for i in range(2):
            writeSmv1(num_of_players, BOARD_COLS - 1, self.p1, a_vecs, l_vecs)
            ans,r=runSmv1()
            self.p1.state=ans
